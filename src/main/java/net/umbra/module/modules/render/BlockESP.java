...
import net.umbra.module.modules.render.Tracer.TracerMode;
...
public class BlockESP extends Module implements TickListener, Render3DListener, ChunkListener {
	...
	public void onDisable() {
		...
		Umbra.getInstance().eventManager.RemoveListener(ChunkListener.class, this);
	...
	public void onEnable() {
		...
		Umbra.getInstance().eventManager.AddListener(ChunkListener.class, this);
