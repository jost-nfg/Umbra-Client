...
import net.umbra.interfaces.IMultiPlayerGameMode;
...
public abstract class Module {
	...
	protected final IMinecraft IMC = UmbraClient.IMC;
	protected static final UmbraClient UMBRA_CLIENT = Umbra.getInstance();
	 ...
	 */
	public void toggle() {
		if (isDetectable(UMBRA_CLIENT.moduleManager.antiCheat.getValue()))
	...
	public static boolean swap(int slot, boolean swapBack) {
		...
		((IMultiPlayerGameMode) MC.gameMode).umbra$syncSelected();
		return true;
	}
