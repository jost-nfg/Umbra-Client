...
package net.umbra.managers.rotation;
...
import net.umbra.mixin.interfaces.IServerboundUseItemPacket;
...
public class RotationManager implements TickListener, Render3DListener, SendPacketListener, SendMovementPacketListener {
	...
	private static final UmbraClient UMBRA = Umbra.getInstance();
	...
	public RotationManager() {
		UMBRA.eventManager.AddListener(TickListener.class, this);
		UMBRA.eventManager.AddListener(Render3DListener.class, this);
		UMBRA.eventManager.AddListener(SendPacketListener.class, this);
		UMBRA.eventManager.AddListener(SendMovementPacketListener.class, this);
	}
