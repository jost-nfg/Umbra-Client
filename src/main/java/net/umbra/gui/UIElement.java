...
import net.umbra.gui.UIProperty.CoerseCallback;
...
public abstract class UIElement {
	...
	protected static UmbraClient UMBRA = Umbra.getInstance();
	...
	public static final UIProperty<UIFont> FontProperty = new UIProperty<>("Font", Umbra.getInstance().fontManager.getDefaultFont(), true, true);
