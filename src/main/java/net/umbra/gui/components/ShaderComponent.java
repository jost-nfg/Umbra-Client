...
import net.umbra.rendering.shaders.ShaderUniform;
import net.umbra.rendering.shaders.ShaderUniformType;
...
public class ShaderComponent extends Component {
	...
	public ShaderComponent() {
		...
		List<Shader> shaders = UMBRA.shaderManager.getAvailableShaders();
	...
	private void onShaderChanged(Object name) {
		...
		for (Shader e : UMBRA.shaderManager.getAvailableShaders()) {
